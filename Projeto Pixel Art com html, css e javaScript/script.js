...
if (savedColors.every(check)){
    ...
    usedColors.appendChild(button); // Use appendChild to add to specific element
  };
...
link.href = img;
link.download = "pixelart.png"; // Set the desired filename here
link.click();

link.href = img;
link.dowload = "pixelart.png";
